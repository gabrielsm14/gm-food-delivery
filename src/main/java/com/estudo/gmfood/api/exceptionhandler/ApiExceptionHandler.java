...
@ControllerAdvice // diz que dentro desse componente podemos adicionar exception handler que as exceções de todos os controladores serão tratadas por aqui 
public class ApiExceptionHandler {
	...
	public ResponseEntity<?> tratarNegocioExecption(NegocioException e) {
		Problema problema = Problema.builder()
				.dataHora(LocalDateTime.now())
				.mensagem(e.getMessage()).build();
